    ...
    <DashboardLayout user={user}>
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage your company profile and business information</p>
        </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="flex items-center space-x-6">
                      ...
                      <div className="flex-1">
                        <Label htmlFor="avatar">Company Logo URL</Label>
                        <Input
                          id="avatar"
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center space-x-6">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Poultry Supply Company</p>
                    ...
                    {profile.bio && (
                      <div>
                        <h3 className="text-lg font-medium mb-2">About Our Company</h3>
          ...
          <TabsContent value="business">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage your business operations and partnerships</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {profile.dashboardSlug && (
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                      <h4 className="font-medium">Company Store</h4>
                      <p className="text-sm text-gray-600">
                        Your public company store
                      </p>
                      <p className="text-sm text-blue-600 font-mono">
                        /store/{profile.dashboardSlug}
                      </p>
                    </div>
                    <div className="flex space-x-2">
                      <Button variant="outline" asChild>
                        <a href={`/store/${profile.dashboardSlug}`} target="_blank">
                          <Building2 className="h-4 w-4 mr-2" />
                          View Store
                        </a>
                      </Button>
                      <Button variant="outline" asChild>
                        <a href="/company/qr-code">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    <h4 className="font-medium">Sponsorship Program</h4>
                    <p className="text-sm text-gray-600">
                      Manage your seller sponsorships and partnerships
                    </p>
                  </div>
                  <Button variant="outline" asChild>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Manage feeds, chicks, and hatching eggs
                    </p>
                  </div>
                  <Button variant="outline" asChild>
                    <a href="/company/products">Manage Products</a>
                  </Button>
                </div>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  ...
                  <Button variant="outline" asChild>
                    <a href="/company/analytics">View Analytics</a>
                  </Button>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Your company verification and trust badges
                    </p>
                  </div>
                ...
                {profile.customDomain && (
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Your custom domain for the store
                      </p>
                      <p className="text-sm text-blue-600 font-mono">
                        {profile.customDomain}
                      </p>
