...
export default async function CompanyDashboard() {
  ...
  const [products, orders, totalRevenue, recentOrders, sponsorships] = await Promise.all([
      ...
      <div className="space-y-8">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-gray-600 mt-2">Manage your company products and track your business performance.</p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage your company account</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Link href="/company/sponsorships">
                <Button className="w-full" variant="outline">
