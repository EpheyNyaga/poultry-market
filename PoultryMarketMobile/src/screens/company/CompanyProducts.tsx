...
export const CompanyProducts: React.FC<CompanyProductsProps> = ({ navigation }) => {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'CHICKS': return 'warning';
      case 'HATCHING_EGGS': return 'info';
  ...
  if (loading && companyProducts.length === 0) {
    ...
    <StyledSafeAreaView className="flex-1">
      ...
      >
        ...
        <StyledScrollView
          ...
          refreshControl={
            <RefreshControl refreshing={loading} onRefresh={loadCompanyProducts} />
          }
        >
